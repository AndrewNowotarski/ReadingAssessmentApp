...
{
    /// <summary>
    /// Methods to determine similarity between two strings using the Levenstein algorithm.
    ...
    /// </summary>
    public static class ReadingAccuracy
    {
        /// <summary>
        ...
        {
            /* Strip out all punctuation and normalize the case. */
            return Regex.Replace(text, @"[^\w\s]", "").ToLower();
        }
    }
}
